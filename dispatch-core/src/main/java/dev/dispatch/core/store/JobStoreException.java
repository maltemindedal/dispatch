...
/**
 * How a {@link JobStore} reports that storage itself failed, such as a lost connection or broken
 * schema, as opposed to an answer like "not found", which the interface expresses as a return
 * value.
 *
